...
export default {
    ...
    "forgot_password.enter_your_email": "Enter your email",
    ...
    "reset_password.enter_new_password": "Enter your new password",
    "reset_password.confirm_password": "Confirm Password",
    "reset_password.repeat_new_password": "Repeat your new password",
    ...
    "profile.downloads_total": "Total Downloads",
    "profile.mods_published": "Mods Published",
    "profile.favorites": "Favorites",
    "profile.reviews": "Reviews",
    "profile.avg_rating": "Avg. Rating",
    "profile.mods_by": "Mods by",
    // Mod
    "by": "by",
    ...
    "upload.Images must be in .png, .jpeg, .jpg, .webp or .gif format": "Images must be in .png, .jpeg, .jpg, .webp or .gif format",
    "upload.Mod Side": "Mod Side",
    "upload.Select mod side": "Select mod side",
    "upload.Client Side": "Client Side",
    "upload.Server Side": "Server Side",
    "upload.Both": "Both",
    "upload.Multiplayer Compatible": "Multiplayer Compatible",
    "upload.Requires All Players": "Requires All Players",
    ...
    "If an account with that email exists, a reset link has been sent. Check your inbox.": "If an account with that email exists, a reset link has been sent. Check your inbox.",
    "Password reset successfully! Redirecting to login...": "Password reset successfully! Redirecting to login...",
    ...
    "Mod file must be less than 500MB!": "Mod file must be less than 500MB!",
